...
<main>
  <section id="proyecto" aria-label="Descripción del Proyecto">
    <h2>Proyecto</h2>
    <p>Huerto Inteligente es un sistema modular, inteligente y de bajo costo que permite monitorear la humedad del suelo en huertos urbanos y rurales. El sistema utiliza sensores IoT que envían información en tiempo real a una plataforma web segura y responsiva, accesible desde cualquier dispositivo. Gracias a esta tecnología, los usuarios pueden tomar decisiones precisas de riego y cuidado de cultivos, optimizando el uso del agua y minimizando riesgos por exceso o déficit hídrico. Su diseño modular permite la expansión y adaptación según las necesidades de cada huerto, haciendo que la agricultura inteligente sea más accesible, eficiente y sostenible.</p>
  </section>

  <section aria-label="Visión del Proyecto">
    <h2>Visión</h2>
    <p>Visualizamos un futuro en el que Huerto Inteligente sea una herramienta ampliamente adoptada por pequeños productores, escuelas y huertos urbanos, promoviendo prácticas agrícolas más sostenibles e innovadoras. La flexibilidad del sistema permite agregar módulos o sensores adicionales, garantizando soluciones personalizadas y escalables que se adapten a diferentes tipos de cultivos y contextos. Aspiramos a que nuestra tecnología facilite la toma de decisiones informadas, apoyando la eficiencia y el crecimiento del sector agrícola.</p>
  </section>
 ...
 <section aria-label="Ventajas del proyecto">
  ...
  <section aria-label="Impacto del proyecto">
    <h2>Impacto</h2>
    <p>El sistema Huerto Inteligente genera beneficios significativos en distintos ámbitos. Permite optimizar el uso del agua, reduciendo desperdicios y disminuyendo los costos asociados al riego, mientras ofrece un control preciso de las condiciones del suelo para favorecer un crecimiento saludable de los cultivos. Además, fomenta prácticas responsables y contribuye a la conciencia ambiental, destacando la importancia del cuidado del agua y del medio ambiente. De manera complementaria, acerca la tecnología IoT a escuelas, huertos urbanos y pequeños productores, promoviendo la capacitación y el desarrollo de la cultura digital aplicada a la agricultura, lo que convierte al sistema en una herramienta innovadora y sostenible.</p>
  </section>
...
<script>
  ...
  const texts = {
    es: {
      ...
      proyectoDesc: "Huerto Inteligente es un sistema modular, inteligente y de bajo costo que permite monitorear la humedad del suelo en huertos urbanos y rurales. El sistema utiliza sensores IoT que envían información en tiempo real a una plataforma web segura y responsiva, accesible desde cualquier dispositivo. Gracias a esta tecnología, los usuarios pueden tomar decisiones precisas de riego y cuidado de cultivos, optimizando el uso del agua y minimizando riesgos por exceso o déficit hídrico. Su diseño modular permite la expansión y adaptación según las necesidades de cada huerto, haciendo que la agricultura inteligente sea más accesible, eficiente y sostenible.",
      visionTitle: "Visión",
      visionDesc: "Visualizamos un futuro en el que Huerto Inteligente sea una herramienta ampliamente adoptada por pequeños productores, escuelas y huertos urbanos, promoviendo prácticas agrícolas más sostenibles e innovadoras. La flexibilidad del sistema permite agregar módulos o sensores adicionales, garantizando soluciones personalizadas y escalables que se adapten a diferentes tipos de cultivos y contextos. Aspiramos a que nuestra tecnología facilite la toma de decisiones informadas, apoyando la eficiencia y el crecimiento del sector agrícola.",
...
ventajas: [
  ...
  {icon:"https://img.icons8.com/?size=100&id=97612&format=png&color=000000", title:"Fomenta la Comunidad", desc:"Ideal para huertos escolares o urbanos, promoviendo colaboración y aprendizaje."}
      ...
      impactoDesc: "El sistema Huerto Inteligente genera beneficios significativos en distintos ámbitos. Permite optimizar el uso del agua, reduciendo desperdicios y disminuyendo los costos asociados al riego, mientras ofrece un control preciso de las condiciones del suelo para favorecer un crecimiento saludable de los cultivos. Además, fomenta prácticas responsables y contribuye a la conciencia ambiental, destacando la importancia del cuidado del agua y del medio ambiente. De manera complementaria, acerca la tecnología IoT a escuelas, huertos urbanos y pequeños productores, promoviendo la capacitación y el desarrollo de la cultura digital aplicada a la agricultura, lo que convierte al sistema en una herramienta innovadora y sostenible.",
      equipoTitle: "Equipo",
      equipo: [
    ...
    en: {
      ...
      proyectoDesc: "Smart Garden is a modular, intelligent, and cost-effective system that monitors soil moisture in urban and rural gardens. The system uses IoT sensors that send real-time information to a secure and agile web platform, accessible from any device. Thanks to this technology, users can make accurate decisions about irrigation and crop care, optimizing water use and minimizing the risk of excess or deficit water. Its modular design allows for expansion and adaptation according to the needs of each garden, making smart agriculture more accessible, efficient, and sustainable.",
      visionTitle: "Vision",
      visionDesc: "We envision a future where Smart Garden is a widely adopted tool by small producers, schools, and urban gardens, promoting more sustainable and innovative agricultural practices. The system's flexibility allows for the addition of additional modules or sensors, ensuring customized and scalable solutions that adapt to different crop types and contexts. We aspire for our technology to facilitate informed decision-making, supporting the efficiency and growth of the agricultural sector.",
...
ventajas: [
  ...
  {icon:"https://img.icons8.com/?size=100&id=97612&format=png&color=000000", title:"Community Focus", desc:"Ideal for school or urban gardens, promoting collaboration and learning."}
      ...
      impactoTitle: "Impact",
      impactoDesc: "The Smart Garden system generates significant benefits in various areas. It optimizes water use, reducing waste and lowering irrigation costs, while offering precise control of soil conditions to promote healthy crop growth. It also encourages responsible practices and contributes to environmental awareness, highlighting the importance of water and environmental protection. Additionally, it brings IoT technology to schools, urban gardens, and small-scale farmers, promoting training and developing digital literacy applied to agriculture, making the system an innovative and sustainable tool.",
      equipoTitle: "Team",
      equipo: [
